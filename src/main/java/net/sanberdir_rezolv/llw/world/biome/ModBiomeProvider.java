...
import static net.sanberdir_rezolv.llw.LLW.MODID;


public class ModBiomeProvider extends Region {
    public ModBiomeProvider() {
        super(new ResourceLocation(MODID, "biome_provider"), RegionType.OVERWORLD, 10);
    }
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper)
    {
        ...
        addModifiedVanillaOverworldBiomes(mapper, builder -> {
                ...
                List<Climate.ParameterPoint> flowerForestPoints = RegionUtils.getVanillaParameterPoints(Biomes.FOREST).stream().collect(ImmutableList.toImmutableList());
                flowerForestPoints.forEach(point -> builder.replaceBiome(point, ModBiomeInitializer.MAGIC_FOREST));
